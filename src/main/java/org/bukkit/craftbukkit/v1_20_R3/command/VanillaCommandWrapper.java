...
public class VanillaCommandWrapper extends BukkitCommand { // Paper
	...
	// needed for ABI compatibility :c
	public VanillaCommandWrapper(Commands dispatcher, CommandNode<CommandSourceStack> vanillaCommand) {
		this(vanillaCommand.getName(), "A Mojang provided command.", vanillaCommand.getUsageText(), Collections.emptyList(), vanillaCommand, "Minecraft");

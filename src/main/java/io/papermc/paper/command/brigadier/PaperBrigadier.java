...
public final class PaperBrigadier {
	...
	public static Command wrapNode(CommandNode node) {
		...
		if ((meta = ((CommandNodeAccess) node).monumenta$getApiCommandMeta()) == null) {
		...
		Map<CommandNode<CommandSourceStack>, String> map = PaperCommands.INSTANCE.getDispatcherInternal().getSmartUsage(argumentCommandNode, (CommandSourceStack) DUMMY);

 ...
 */
public abstract class ApiMirrorRootNode extends RootCommandNode<CommandSourceStack> implements CommandNodeAccess {
	...
	private @NotNull CommandNode<CommandSourceStack> unwrapNode(final CommandNode<CommandSourceStack> maybeWrappedNode) {
		 ...
		 */
		if (((CommandNodeAccess) maybeWrappedNode).monumenta$getUnwrappedCached() != null) {
			return ((CommandNodeAccess) maybeWrappedNode).monumenta$getUnwrappedCached();
		}
	...
	private @NotNull CommandNode<CommandSourceStack> convertFromPureBrigNode(final CommandNode<CommandSourceStack> pureNode) {
		...
		((CommandNodeAccess) converted).monumenta$setWrappedCached(pureNode);
		((CommandNodeAccess) pureNode).monumenta$setUnwrappedCached(converted);
	...
	private @Nullable CommandNode<CommandSourceStack> wrapNode(@Nullable final CommandNode<net.minecraft.commands.CommandSourceStack> unwrapped) {
		 ...
		 */
		if (((CommandNodeAccess) unwrapped).monumenta$getWrappedCached() != null) {
			return ((CommandNodeAccess) unwrapped).monumenta$getWrappedCached();
		}
	...
	public void monumenta$clearAll() {
		((CommandNodeAccess) this.getDispatcher().getRoot()).monumenta$clearAll();
	}

...
public final class LifecycleEvents {
	...
	/**
	 * This event is for registering commands to the server's brigadier command system. You can register a handler
	 * for this event in
	 * {@link org.bukkit.plugin.java.JavaPlugin#onEnable()} or
	 * {@link io.papermc.paper.plugin.bootstrap.PluginBootstrap#bootstrap(BootstrapContext)}.
	 *

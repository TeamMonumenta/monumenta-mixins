package com.floweytf.monumentapaper.mixin.core.behaviour;

import com.floweytf.monumentapaper.api.CustomMeleeAttackGoal;
...
public class MeleeAttackGoalMixin implements CustomMeleeAttackGoal {
    ...
    private boolean monumenta$redirectCanUse(PathfinderMob instance,
